...
.bg-map {
  width: 100%;
  height: 100%;
  background-image: url("../../assets/images/maps/crag.png");
...
.bg-pets {
  ...
  width: 672px;
  height: 537px;
  background-image: url("../../assets/images/maps/crag-pets.png");
  background-repeat: no-repeat;
}
.bg-icon {
  top: 84px;
  ...
  width: 495px;
  height: 470px;
  background-image: url("../../assets/images/maps/crag-icon.png");
  background-repeat: no-repeat;
}
.map-wrapper {
  max-width: 100%;
