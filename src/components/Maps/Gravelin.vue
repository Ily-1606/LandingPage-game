...
.bg-map {
  width: 100%;
  height: 100%;
  background-image: url("../../assets/images/maps/gravelin.png");
...
.bg-pets {
  ...
  width: 662px;
  height: 575px;
  background-image: url("../../assets/images/maps/gravelin-pets.png");
  background-repeat: no-repeat;
}
.bg-icon {
  top: 60px;
  ...
  width: 525px;
  height: 474px;
  background-image: url("../../assets/images/maps/gravelin-icon.png");
  background-repeat: no-repeat;
}
.map-wrapper {
  width: 1197px;
